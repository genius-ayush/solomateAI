      ...
      <div className='flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4'>
        <a className='block w-[12rem] xl-[12rem] xl-mr-8'>
          <div className='flex gap-2 '>
            ...
            <span className='text-white text-2xl'>solomate</span>
          </div>
        </a>
...
${item.url === activeLink ? "z-2 lg:text-n-1"
        ...
        <Button variant="ghost" className="text-purple-200 hover:text-color-1 hover:bg-n-8 border-1 hidden lg:flex bg-n-8 button">
          Login
        </Button>
